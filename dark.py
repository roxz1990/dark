...
async def attack(update: Update, context: CallbackContext):
    ...
    text=(
        ...
        f"*🔥chudai chalu h feedback bhej dena @Roxz_gaming💥*"
    ),
    parse_mode='Markdown'
)
